...
ADAPTER=nextera
PHIX_REF="/home/wbvr006/miniconda3/envs/amr-bbmap/opt/bbmap-39.06-1/resources/phix174_ill.ref.fa.gz"
...
# PHIX FILTER
bbduk.sh in1="$FILTERED1" in2="$FILTERED2" out1="$PHIX1" out2="$PHIX2" ref="$PHIX_REF" k=31 hdist=1 stats="$stats" ow >> "$LOG0" 2>&1
# READ ERROR CORRECTION
tadpole.sh in1="$PHIX1" in2="$PHIX2" out1="$CORRECTED1" out2="$CORRECTED2" mode=correct ow >> "$LOG0" 2>&1
# ADAPTER TRIM
...
# PHIX FILTER
bbduk.sh in1="$R1" in2="$R2" out1="$PHIX1" out2="$PHIX2" ref="$PHIX_REF" k=31 hdist=1 stats="$stats" ow >> "$LOG0" 2>&1
# READ ERROR CORRECTION
tadpole.sh in1="$PHIX1" in2="$PHIX2" out1="$CORRECTED1" out2="$CORRECTED2" mode=correct ow >> "$LOG0" 2>&1; ## aangepast alleen voor deze dataset
# ADAPTER TRIM
